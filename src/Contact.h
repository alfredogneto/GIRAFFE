...
public:
	...
	virtual void BeginStepCheck() = 0;											//checagem inicial do contato  - início de cada incremento
	virtual void SaveLagrange() = 0;											//Salva variáveis para descrição lagrangiana atualizada
	virtual bool HaveErrors() = 0;												//Retorna 1 - há algum erro, mesmo que tenha convergido. Ex: penetração excessiva
