...
void RigidTriangularFace_RigidTriangularFace::HessianPhase1Explicit(Matrix& mHes)
{
	double Hes[4][4];
	v = DBG_NEW double[1000];
#pragma region AceGen
	...
	v[213] = -0.5e0 * x1A[1];
	v[216] = -0.5e0 * x1A[2];
	v[209] = v[210] + x2A[0] / 2e0;
	v[212] = v[213] + x2A[1] / 2e0;
	v[215] = v[216] + x2A[2] / 2e0;
	v[211] = v[210] + x3A[0] / 2e0;
	v[214] = v[213] + x3A[1] / 2e0;
	v[217] = v[216] + x3A[2] / 2e0;
	v[35] = QAi[0][0];
	v[36] = QAi[0][1];
	v[37] = QAi[0][2];
	v[38] = QAi[1][0];
	...
	v[45] = Q0A[0][1];
	v[46] = Q0A[0][2];
	v[139] = v[37] * v[44] + v[40] * v[45] + v[43] * v[46];
	v[138] = v[36] * v[44] + v[39] * v[45] + v[42] * v[46];
	v[137] = v[35] * v[44] + v[38] * v[45] + v[41] * v[46];
	v[47] = Q0A[1][0];
	v[48] = Q0A[1][1];
	v[49] = Q0A[1][2];
	v[145] = v[37] * v[47] + v[40] * v[48] + v[43] * v[49];
	v[144] = v[36] * v[47] + v[39] * v[48] + v[42] * v[49];
	v[143] = v[35] * v[47] + v[38] * v[48] + v[41] * v[49];
	v[50] = Q0A[2][0];
	v[51] = Q0A[2][1];
	v[52] = Q0A[2][2];
	v[151] = v[37] * v[50] + v[40] * v[51] + v[43] * v[52];
	v[150] = v[36] * v[50] + v[39] * v[51] + v[42] * v[52];
	v[149] = v[35] * v[50] + v[38] * v[51] + v[41] * v[52];
	v[56] = alphaA[0];
	v[128] = (v[56] * v[56]);
	v[57] = alphaA[1];
	v[258] = v[57] / 2e0;
	...
	v[228] = -0.5e0 * x1B[1];
	v[231] = -0.5e0 * x1B[2];
	v[224] = v[225] + x2B[0] / 2e0;
	v[227] = v[228] + x2B[1] / 2e0;
	v[230] = v[231] + x2B[2] / 2e0;
	v[226] = v[225] + x3B[0] / 2e0;
	v[229] = v[228] + x3B[1] / 2e0;
	v[232] = v[231] + x3B[2] / 2e0;
	v[75] = QBi[0][0];
	v[76] = QBi[0][1];
	v[77] = QBi[0][2];
	v[78] = QBi[1][0];
	...
	v[85] = Q0B[0][1];
	v[86] = Q0B[0][2];
	v[187] = v[77] * v[84] + v[80] * v[85] + v[83] * v[86];
	v[186] = v[76] * v[84] + v[79] * v[85] + v[82] * v[86];
	v[185] = v[75] * v[84] + v[78] * v[85] + v[81] * v[86];
	v[87] = Q0B[1][0];
	v[88] = Q0B[1][1];
	v[89] = Q0B[1][2];
	v[193] = v[77] * v[87] + v[80] * v[88] + v[83] * v[89];
	v[192] = v[76] * v[87] + v[79] * v[88] + v[82] * v[89];
	v[191] = v[75] * v[87] + v[78] * v[88] + v[81] * v[89];
	v[90] = Q0B[2][0];
	v[91] = Q0B[2][1];
	v[92] = Q0B[2][2];
	v[199] = v[77] * v[90] + v[80] * v[91] + v[83] * v[92];
	v[198] = v[76] * v[90] + v[79] * v[91] + v[82] * v[92];
	v[197] = v[75] * v[90] + v[78] * v[91] + v[81] * v[92];
	v[96] = alphaB[0];
	v[176] = (v[96] * v[96]);
	v[97] = alphaB[1];
	v[259] = v[97] / 2e0;
	...
	v[170] = (v[98] * v[98]);
	v[262] = v[169] + v[170];
	v[120] = 4e0 / (4e0 + v[128] + v[260]);
	v[261] = -0.5e0 * v[120];
	v[123] = 1e0 + v[260] * v[261];
	v[124] = v[120] * (v[126] - v[58]);
	v[125] = v[120] * (v[131] + v[57]);
	v[127] = v[120] * (v[126] + v[58]);
	v[129] = 1e0 + (v[122] + v[128]) * v[261];
	v[130] = v[120] * (v[133] - v[56]);
	v[132] = v[120] * (v[131] - v[57]);
	v[134] = v[120] * (v[133] + v[56]);
	v[135] = 1e0 - (-v[121] - v[128]) * v[261];
	v[136] = v[123] * v[137] + v[127] * v[138] + v[132] * v[139];
	v[140] = v[124] * v[137] + v[129] * v[138] + v[134] * v[139];
	v[141] = v[125] * v[137] + v[130] * v[138] + v[135] * v[139];
	v[219] = v[136] * v[211] + v[140] * v[214] + v[141] * v[217];
	v[264] = 2e0 * v[219];
	v[218] = v[136] * v[209] + v[140] * v[212] + v[141] * v[215];
	v[142] = v[123] * v[143] + v[127] * v[144] + v[132] * v[145];
	v[146] = v[124] * v[143] + v[129] * v[144] + v[134] * v[145];
	v[147] = v[125] * v[143] + v[130] * v[144] + v[135] * v[145];
	v[221] = v[142] * v[211] + v[146] * v[214] + v[147] * v[217];
	v[265] = 2e0 * v[221];
	v[220] = v[142] * v[209] + v[146] * v[212] + v[147] * v[215];
	v[148] = v[123] * v[149] + v[127] * v[150] + v[132] * v[151];
	v[152] = v[124] * v[149] + v[129] * v[150] + v[134] * v[151];
	v[153] = v[125] * v[149] + v[130] * v[150] + v[135] * v[151];
	v[223] = v[148] * v[211] + v[152] * v[214] + v[153] * v[217];
	v[266] = 2e0 * v[223];
	v[222] = v[148] * v[209] + v[152] * v[212] + v[153] * v[215];
	v[168] = 4e0 / (4e0 + v[176] + v[262]);
	v[263] = -0.5e0 * v[168];
	v[171] = 1e0 + v[262] * v[263];
	v[172] = v[168] * (v[174] - v[98]);
	v[173] = v[168] * (v[179] + v[97]);
	v[175] = v[168] * (v[174] + v[98]);
	v[177] = 1e0 + (v[170] + v[176]) * v[263];
	v[178] = v[168] * (v[181] - v[96]);
	v[180] = v[168] * (v[179] - v[97]);
	v[182] = v[168] * (v[181] + v[96]);
	v[183] = 1e0 - (-v[169] - v[176]) * v[263];
	v[184] = v[171] * v[185] + v[175] * v[186] + v[180] * v[187];
	v[188] = v[172] * v[185] + v[177] * v[186] + v[182] * v[187];
	v[189] = v[173] * v[185] + v[178] * v[186] + v[183] * v[187];
	v[234] = v[184] * v[226] + v[188] * v[229] + v[189] * v[232];
	v[233] = v[184] * v[224] + v[188] * v[227] + v[189] * v[230];
	v[267] = 2e0 * v[233];
	v[190] = v[171] * v[191] + v[175] * v[192] + v[180] * v[193];
	v[194] = v[172] * v[191] + v[177] * v[192] + v[182] * v[193];
	v[195] = v[173] * v[191] + v[178] * v[192] + v[183] * v[193];
	v[236] = v[190] * v[226] + v[194] * v[229] + v[195] * v[232];
	v[235] = v[190] * v[224] + v[194] * v[227] + v[195] * v[230];
	v[268] = 2e0 * v[235];
	v[196] = v[171] * v[197] + v[175] * v[198] + v[180] * v[199];
	v[200] = v[172] * v[197] + v[177] * v[198] + v[182] * v[199];
	v[201] = v[173] * v[197] + v[178] * v[198] + v[183] * v[199];
	v[238] = v[196] * v[226] + v[200] * v[229] + v[201] * v[232];
	v[237] = v[196] * v[224] + v[200] * v[227] + v[201] * v[230];
	v[269] = 2e0 * v[237];
	Hes[0][0] = 1e0 * ((v[218] * v[218]) + (v[220] * v[220]) + (v[222] * v[222]));
	Hes[0][1] = 0.5e0 * (v[218] * v[264] + v[220] * v[265] + v[222] * v[266]);
	Hes[0][2] = 0.5e0 * (-(v[218] * v[267]) - v[220] * v[268] - v[222] * v[269]);
	Hes[0][3] = -1e0 * (v[218] * v[234] + v[220] * v[236] + v[222] * v[238]);
	Hes[1][1] = 1e0 * ((v[219] * v[219]) + (v[221] * v[221]) + (v[223] * v[223]));
	Hes[1][2] = 0.5e0 * (-(v[219] * v[267]) - v[221] * v[268] - v[223] * v[269]);
	Hes[1][3] = 0.5e0 * (-(v[234] * v[264]) - v[236] * v[265] - v[238] * v[266]);
	Hes[2][2] = 1e0 * ((v[233] * v[233]) + (v[235] * v[235]) + (v[237] * v[237]));
	Hes[2][3] = 0.5e0 * (v[234] * v[267] + v[236] * v[268] + v[238] * v[269]);
	Hes[3][3] = 1e0 * ((v[234] * v[234]) + (v[236] * v[236]) + (v[238] * v[238]));
	for (i02 = 1; i02 < 4; i02++) {
		for (i03 = 0; i03 < i02; i03++) {
			Hes[i02][i03] = Hes[i03][i02];
		}
	};
	delete[] v;
	for (int i = 0; i < 4; i++)
...
void RigidTriangularFace_RigidTriangularFace::MountLocalContributionsExplicit(double t)
{
	...
	else if (type_approach == 3) // com expressões
	{
		...
		int b292, b297, b329, b749, b750, b751, b752, b758, b759, b769, b785, b786, b788, b804, b822
			, b834;
		v[1] = gti[0];
		v[2] = gti[1];
		v[3] = gti[2];
		...
		v[347] = -0.5e0 * v[35];
		v[36] = x2A[0];
		v[336] = v[343] + v[36] / 2e0;
		v[37] = x2A[1];
		v[337] = v[345] + v[37] / 2e0;
		v[38] = x2A[2];
		v[338] = v[347] + v[38] / 2e0;
		v[39] = x3A[0];
		v[344] = v[343] + v[39] / 2e0;
		v[40] = x3A[1];
		v[346] = v[345] + v[40] / 2e0;
		v[41] = x3A[2];
		v[348] = v[347] + v[41] / 2e0;
		v[42] = xAi[0];
		v[43] = xAi[1];
		v[44] = xAi[2];
		v[45] = QAi[0][0];
		...
		v[55] = Q0A[0][1];
		v[56] = Q0A[0][2];
		v[172] = v[47] * v[54] + v[50] * v[55] + v[53] * v[56];
		v[171] = v[46] * v[54] + v[49] * v[55] + v[52] * v[56];
		v[170] = v[45] * v[54] + v[48] * v[55] + v[51] * v[56];
		v[57] = Q0A[1][0];
		v[58] = Q0A[1][1];
		v[59] = Q0A[1][2];
		v[178] = v[47] * v[57] + v[50] * v[58] + v[53] * v[59];
		v[177] = v[46] * v[57] + v[49] * v[58] + v[52] * v[59];
		v[176] = v[45] * v[57] + v[48] * v[58] + v[51] * v[59];
		v[60] = Q0A[2][0];
		v[61] = Q0A[2][1];
		v[62] = Q0A[2][2];
		v[184] = v[47] * v[60] + v[50] * v[61] + v[53] * v[62];
		v[183] = v[46] * v[60] + v[49] * v[61] + v[52] * v[62];
		v[182] = v[45] * v[60] + v[48] * v[61] + v[51] * v[62];
		v[66] = alphaA[0];
		v[370] = 2e0 * v[66];
		v[158] = (v[66] * v[66]);
		v[67] = alphaA[1];
		...
		v[406] = -v[152] - v[158];
		v[387] = -v[151] - v[152];
		v[382] = 4e0 + v[151] + v[152] + v[158];
		v[901] = -4e0 / (v[382] * v[382]);
		v[386] = v[375] * v[901];
		v[907] = v[386] / 2e0;
		v[428] = v[424] * v[907];
		v[385] = v[373] * v[901];
		...
		v[364] = -0.5e0 * v[81];
		v[82] = x2B[0];
		v[353] = v[360] + v[82] / 2e0;
		v[83] = x2B[1];
		v[354] = v[362] + v[83] / 2e0;
		v[84] = x2B[2];
		v[355] = v[364] + v[84] / 2e0;
		v[85] = x3B[0];
		v[361] = v[360] + v[85] / 2e0;
		v[86] = x3B[1];
		v[363] = v[362] + v[86] / 2e0;
		v[87] = x3B[2];
		v[365] = v[364] + v[87] / 2e0;
		v[88] = xBi[0];
		v[89] = xBi[1];
		v[90] = xBi[2];
		v[91] = QBi[0][0];
		...
		v[101] = Q0B[0][1];
		v[102] = Q0B[0][2];
		v[237] = v[100] * v[93] + v[101] * v[96] + v[102] * v[99];
		v[236] = v[100] * v[92] + v[101] * v[95] + v[102] * v[98];
		v[235] = v[100] * v[91] + v[101] * v[94] + v[102] * v[97];
		v[103] = Q0B[1][0];
		v[104] = Q0B[1][1];
		v[105] = Q0B[1][2];
		v[243] = v[103] * v[93] + v[104] * v[96] + v[105] * v[99];
		v[242] = v[103] * v[92] + v[104] * v[95] + v[105] * v[98];
		v[241] = v[103] * v[91] + v[104] * v[94] + v[105] * v[97];
		v[106] = Q0B[2][0];
		v[107] = Q0B[2][1];
		v[108] = Q0B[2][2];
		v[249] = v[106] * v[93] + v[107] * v[96] + v[108] * v[99];
		v[248] = v[106] * v[92] + v[107] * v[95] + v[108] * v[98];
		v[247] = v[106] * v[91] + v[107] * v[94] + v[108] * v[97];
		v[112] = alphaB[0];
		v[376] = 2e0 * v[112];
		v[223] = (v[112] * v[112]);
		v[113] = alphaB[1];
		...
		v[520] = v[112] + v[228];
		v[512] = -v[112] + v[228];
		v[226] = (v[112] * v[114]) / 2e0;
		v[516] = -v[113] + v[226];
		v[499] = v[113] + v[226];
		v[217] = (v[114] * v[114]);
		v[507] = -v[217] - v[223];
		v[488] = -v[216] - v[217];
		v[483] = 4e0 + v[216] + v[217] + v[223];
		v[903] = -4e0 / (v[483] * v[483]);
		v[487] = v[381] * v[903];
		v[911] = v[487] / 2e0;
		v[529] = v[525] * v[911];
		v[486] = v[379] * v[903];
		...
		v[141] = 0.5e0 - v[140];
		v[143] = 0.5e0 - v[142];
		v[144] = v[134] * v[33] + v[136] * v[36] + v[138] * v[39];
		v[145] = v[134] * v[34] + v[136] * v[37] + v[138] * v[40];
		v[146] = v[134] * v[35] + v[136] * v[38] + v[138] * v[41];
		v[147] = v[139] * v[33] + v[141] * v[36] + v[143] * v[39];
		v[148] = v[139] * v[34] + v[141] * v[37] + v[143] * v[40];
		v[149] = v[139] * v[35] + v[141] * v[38] + v[143] * v[41];
		v[150] = 4e0 / v[382];
		v[905] = -0.5e0 * v[150];
		v[426] = v[373] * v[905];
		v[427] = v[426] + v[424] * v[904];
		v[423] = v[370] * v[905];
		v[425] = v[423] + v[424] * v[906];
		v[420] = v[150] + v[383] * v[419];
		v[417] = -v[150] + v[385] * v[415];
		v[412] = -v[150] + v[383] * v[411];
		v[409] = v[375] * v[905];
		v[410] = v[409] + v[406] * v[907];
		v[407] = v[423] + v[406] * v[906];
		v[405] = v[150] + v[386] * v[402];
		v[400] = v[150] + v[385] * v[398];
		v[397] = v[68] * v[905];
		v[421] = -v[397] + v[385] * v[419];
		v[416] = -v[397] + v[383] * v[415];
		v[413] = -v[397] + v[385] * v[411];
		v[466] = v[182] * v[400] + v[183] * v[413] + v[184] * v[427];
		v[451] = v[176] * v[400] + v[177] * v[413] + v[178] * v[427];
		v[436] = v[170] * v[400] + v[171] * v[413] + v[172] * v[427];
		v[399] = -v[397] + v[383] * v[398];
		v[465] = v[182] * v[399] + v[183] * v[412] + v[184] * v[425];
		v[450] = v[176] * v[399] + v[177] * v[412] + v[178] * v[425];
		v[435] = v[170] * v[399] + v[171] * v[412] + v[172] * v[425];
		v[396] = -v[150] + v[386] * v[392];
		v[394] = v[66] * v[905];
		v[418] = -v[394] + v[386] * v[415];
		v[404] = -v[394] + v[385] * v[402];
		v[401] = -v[394] + v[386] * v[398];
		v[395] = v[385] * v[392] - v[394];
		v[463] = v[182] * v[395] + v[183] * v[408] + v[184] * v[421];
		v[448] = v[176] * v[395] + v[177] * v[408] + v[178] * v[421];
		v[433] = v[170] * v[395] + v[171] * v[408] + v[172] * v[421];
		v[391] = -(v[67] * v[905]);
		v[422] = v[391] + v[386] * v[419];
		v[464] = v[182] * v[396] + v[183] * v[410] + v[184] * v[422];
		v[449] = v[176] * v[396] + v[177] * v[410] + v[178] * v[422];
		v[434] = v[170] * v[396] + v[171] * v[410] + v[172] * v[422];
		v[414] = v[391] + v[386] * v[411];
		v[467] = v[182] * v[401] + v[183] * v[414] + v[184] * v[428];
		v[452] = v[176] * v[401] + v[177] * v[414] + v[178] * v[428];
		v[437] = v[170] * v[401] + v[171] * v[414] + v[172] * v[428];
		v[403] = v[391] + v[383] * v[402];
		v[459] = v[182] * v[388] + v[183] * v[403] + v[184] * v[416];
		v[444] = v[176] * v[388] + v[177] * v[403] + v[178] * v[416];
		v[429] = v[170] * v[388] + v[171] * v[403] + v[172] * v[416];
		v[393] = v[391] + v[383] * v[392];
		v[462] = v[182] * v[393] + v[183] * v[407] + v[184] * v[420];
		v[480] = v[144] * v[459] + v[145] * v[462] + v[146] * v[465];
		v[447] = v[176] * v[393] + v[177] * v[407] + v[178] * v[420];
		v[477] = v[144] * v[444] + v[145] * v[447] + v[146] * v[450];
		v[432] = v[170] * v[393] + v[171] * v[407] + v[172] * v[420];
		v[474] = v[144] * v[429] + v[145] * v[432] + v[146] * v[435];
		v[390] = v[409] + v[387] * v[907];
		v[461] = v[182] * v[390] + v[183] * v[405] + v[184] * v[418];
		v[482] = v[144] * v[461] + v[145] * v[464] + v[146] * v[467];
		v[446] = v[176] * v[390] + v[177] * v[405] + v[178] * v[418];
		v[479] = v[144] * v[446] + v[145] * v[449] + v[146] * v[452];
		v[431] = v[170] * v[390] + v[171] * v[405] + v[172] * v[418];
		v[476] = v[144] * v[431] + v[145] * v[434] + v[146] * v[437];
		v[389] = v[426] + v[387] * v[904];
		v[460] = v[182] * v[389] + v[183] * v[404] + v[184] * v[417];
		v[481] = v[144] * v[460] + v[145] * v[463] + v[146] * v[466];
		v[445] = v[176] * v[389] + v[177] * v[404] + v[178] * v[417];
		v[478] = v[144] * v[445] + v[145] * v[448] + v[146] * v[451];
		v[430] = v[170] * v[389] + v[171] * v[404] + v[172] * v[417];
		v[475] = v[144] * v[430] + v[145] * v[433] + v[146] * v[436];
		v[153] = 1e0 - v[387] * v[905];
		v[154] = v[150] * v[392];
		v[155] = v[150] * v[398];
		v[157] = v[150] * v[402];
		v[159] = 1e0 - v[406] * v[905];
		v[160] = v[150] * v[411];
		v[162] = v[150] * v[415];
		v[164] = v[150] * v[419];
		v[165] = 1e0 - v[424] * v[905];
		v[169] = v[153] * v[170] + v[157] * v[171] + v[162] * v[172];
		v[173] = v[154] * v[170] + v[159] * v[171] + v[164] * v[172];
		v[174] = v[155] * v[170] + v[160] * v[171] + v[165] * v[172];
		v[349] = v[169] * v[344] + v[173] * v[346] + v[174] * v[348];
		v[339] = v[169] * v[336] + v[173] * v[337] + v[174] * v[338];
		v[175] = v[153] * v[176] + v[157] * v[177] + v[162] * v[178];
		v[179] = v[154] * v[176] + v[159] * v[177] + v[164] * v[178];
		v[180] = v[155] * v[176] + v[160] * v[177] + v[165] * v[178];
		v[350] = v[175] * v[344] + v[179] * v[346] + v[180] * v[348];
		v[340] = v[175] * v[336] + v[179] * v[337] + v[180] * v[338];
		v[181] = v[153] * v[182] + v[157] * v[183] + v[162] * v[184];
		v[185] = v[154] * v[182] + v[159] * v[183] + v[164] * v[184];
		v[186] = v[155] * v[182] + v[160] * v[183] + v[165] * v[184];
		v[351] = v[181] * v[344] + v[185] * v[346] + v[186] * v[348];
		v[341] = v[181] * v[336] + v[185] * v[337] + v[186] * v[338];
		v[199] = v[200] + v[202];
		v[201] = 0.5e0 - v[200];
		v[203] = 0.5e0 - v[202];
		v[204] = v[205] + v[207];
		v[206] = 0.5e0 - v[205];
		v[208] = 0.5e0 - v[207];
		v[209] = v[199] * v[79] + v[201] * v[82] + v[203] * v[85];
		v[210] = v[199] * v[80] + v[201] * v[83] + v[203] * v[86];
		v[211] = v[199] * v[81] + v[201] * v[84] + v[203] * v[87];
		v[212] = v[204] * v[79] + v[206] * v[82] + v[208] * v[85];
		v[213] = v[204] * v[80] + v[206] * v[83] + v[208] * v[86];
		v[214] = v[204] * v[81] + v[206] * v[84] + v[208] * v[87];
		v[215] = 4e0 / v[483];
		v[909] = -0.5e0 * v[215];
		v[527] = v[379] * v[909];
		v[528] = v[527] + v[525] * v[908];
		v[524] = v[376] * v[909];
		v[526] = v[524] + v[525] * v[910];
		v[521] = v[215] + v[484] * v[520];
		v[518] = -v[215] + v[486] * v[516];
		v[513] = -v[215] + v[484] * v[512];
		v[510] = v[381] * v[909];
		v[511] = v[510] + v[507] * v[911];
		v[508] = v[524] + v[507] * v[910];
		v[506] = v[215] + v[487] * v[503];
		v[501] = v[215] + v[486] * v[499];
		v[498] = v[114] * v[909];
		v[522] = -v[498] + v[486] * v[520];
		v[517] = -v[498] + v[484] * v[516];
		v[514] = -v[498] + v[486] * v[512];
		v[567] = v[247] * v[501] + v[248] * v[514] + v[249] * v[528];
		v[552] = v[241] * v[501] + v[242] * v[514] + v[243] * v[528];
		v[537] = v[235] * v[501] + v[236] * v[514] + v[237] * v[528];
		v[500] = -v[498] + v[484] * v[499];
		v[566] = v[247] * v[500] + v[248] * v[513] + v[249] * v[526];
		v[551] = v[241] * v[500] + v[242] * v[513] + v[243] * v[526];
		v[536] = v[235] * v[500] + v[236] * v[513] + v[237] * v[526];
		v[497] = -v[215] + v[487] * v[493];
		v[495] = v[112] * v[909];
		v[519] = -v[495] + v[487] * v[516];
		v[505] = -v[495] + v[486] * v[503];
		v[502] = -v[495] + v[487] * v[499];
		v[496] = v[486] * v[493] - v[495];
		v[564] = v[247] * v[496] + v[248] * v[509] + v[249] * v[522];
		v[549] = v[241] * v[496] + v[242] * v[509] + v[243] * v[522];
		v[534] = v[235] * v[496] + v[236] * v[509] + v[237] * v[522];
		v[492] = -(v[113] * v[909]);
		v[523] = v[492] + v[487] * v[520];
		v[565] = v[247] * v[497] + v[248] * v[511] + v[249] * v[523];
		v[550] = v[241] * v[497] + v[242] * v[511] + v[243] * v[523];
		v[535] = v[235] * v[497] + v[236] * v[511] + v[237] * v[523];
		v[515] = v[492] + v[487] * v[512];
		v[568] = v[247] * v[502] + v[248] * v[515] + v[249] * v[529];
		v[553] = v[241] * v[502] + v[242] * v[515] + v[243] * v[529];
		v[538] = v[235] * v[502] + v[236] * v[515] + v[237] * v[529];
		v[504] = v[492] + v[484] * v[503];
		v[560] = v[247] * v[489] + v[248] * v[504] + v[249] * v[517];
		v[545] = v[241] * v[489] + v[242] * v[504] + v[243] * v[517];
		v[530] = v[235] * v[489] + v[236] * v[504] + v[237] * v[517];
		v[494] = v[492] + v[484] * v[493];
		v[563] = v[247] * v[494] + v[248] * v[508] + v[249] * v[521];
		v[581] = v[209] * v[560] + v[210] * v[563] + v[211] * v[566];
		v[548] = v[241] * v[494] + v[242] * v[508] + v[243] * v[521];
		v[578] = v[209] * v[545] + v[210] * v[548] + v[211] * v[551];
		v[533] = v[235] * v[494] + v[236] * v[508] + v[237] * v[521];
		v[575] = v[209] * v[530] + v[210] * v[533] + v[211] * v[536];
		v[593] = -(v[349] * v[575]) - v[350] * v[578] - v[351] * v[581];
		v[587] = -(v[339] * v[575]) - v[340] * v[578] - v[341] * v[581];
		v[491] = v[510] + v[488] * v[911];
		v[562] = v[247] * v[491] + v[248] * v[506] + v[249] * v[519];
		v[583] = v[209] * v[562] + v[210] * v[565] + v[211] * v[568];
		v[547] = v[241] * v[491] + v[242] * v[506] + v[243] * v[519];
		v[580] = v[209] * v[547] + v[210] * v[550] + v[211] * v[553];
		v[532] = v[235] * v[491] + v[236] * v[506] + v[237] * v[519];
		v[577] = v[209] * v[532] + v[210] * v[535] + v[211] * v[538];
		v[595] = -(v[349] * v[577]) - v[350] * v[580] - v[351] * v[583];
		v[589] = -(v[339] * v[577]) - v[340] * v[580] - v[341] * v[583];
		v[490] = v[527] + v[488] * v[908];
		v[561] = v[247] * v[490] + v[248] * v[505] + v[249] * v[518];
		v[582] = v[209] * v[561] + v[210] * v[564] + v[211] * v[567];
		v[546] = v[241] * v[490] + v[242] * v[505] + v[243] * v[518];
		v[579] = v[209] * v[546] + v[210] * v[549] + v[211] * v[552];
		v[531] = v[235] * v[490] + v[236] * v[505] + v[237] * v[518];
		v[576] = v[209] * v[531] + v[210] * v[534] + v[211] * v[537];
		v[594] = -(v[349] * v[576]) - v[350] * v[579] - v[351] * v[582];
		v[588] = -(v[339] * v[576]) - v[340] * v[579] - v[341] * v[582];
		v[218] = 1e0 - v[488] * v[909];
		v[219] = v[215] * v[493];
		v[220] = v[215] * v[499];
		v[222] = v[215] * v[503];
		v[224] = 1e0 - v[507] * v[909];
		v[225] = v[215] * v[512];
		v[227] = v[215] * v[516];
		v[229] = v[215] * v[520];
		v[230] = 1e0 - v[525] * v[909];
		v[234] = v[218] * v[235] + v[222] * v[236] + v[227] * v[237];
		v[238] = v[219] * v[235] + v[224] * v[236] + v[229] * v[237];
		v[239] = v[220] * v[235] + v[225] * v[236] + v[230] * v[237];
		v[366] = v[234] * v[361] + v[238] * v[363] + v[239] * v[365];
		v[356] = v[234] * v[353] + v[238] * v[354] + v[239] * v[355];
		v[675] = -(v[29] * v[339]) - v[30] * v[349] + v[31] * v[356] + v[32] * v[366];
		v[660] = -(v[25] * v[339]) - v[26] * v[349] + v[27] * v[356] + v[28] * v[366];
		v[645] = -(v[21] * v[339]) - v[22] * v[349] + v[23] * v[356] + v[24] * v[366];
		v[630] = -(v[17] * v[339]) - v[18] * v[349] + v[19] * v[356] + v[20] * v[366];
		v[928] = v[339] * v[630] + v[349] * v[645] - v[356] * v[660] - v[366] * v[675];
		v[240] = v[218] * v[241] + v[222] * v[242] + v[227] * v[243];
		v[244] = v[219] * v[241] + v[224] * v[242] + v[229] * v[243];
		v[245] = v[220] * v[241] + v[225] * v[242] + v[230] * v[243];
		v[367] = v[240] * v[361] + v[244] * v[363] + v[245] * v[365];
		v[357] = v[240] * v[353] + v[244] * v[354] + v[245] * v[355];
		v[931] = v[340] * v[630] + v[350] * v[645] - v[357] * v[660] - v[367] * v[675];
		v[677] = -(v[29] * v[340]) - v[30] * v[350] + v[31] * v[357] + v[32] * v[367];
		v[662] = -(v[25] * v[340]) - v[26] * v[350] + v[27] * v[357] + v[28] * v[367];
		v[647] = -(v[21] * v[340]) - v[22] * v[350] + v[23] * v[357] + v[24] * v[367];
		v[632] = -(v[17] * v[340]) - v[18] * v[350] + v[19] * v[357] + v[20] * v[367];
		v[932] = v[340] * v[632] + v[350] * v[647] - v[357] * v[662] - v[367] * v[677];
		v[929] = v[339] * v[632] + v[349] * v[647] - v[356] * v[662] - v[366] * v[677];
		v[246] = v[218] * v[247] + v[222] * v[248] + v[227] * v[249];
		v[250] = v[219] * v[247] + v[224] * v[248] + v[229] * v[249];
		v[251] = v[220] * v[247] + v[225] * v[248] + v[230] * v[249];
		v[368] = v[246] * v[361] + v[250] * v[363] + v[251] * v[365];
		v[604] = -(v[366] * v[476]) - v[367] * v[479] - v[368] * v[482];
		v[603] = -(v[366] * v[475]) - v[367] * v[478] - v[368] * v[481];
		v[602] = -(v[366] * v[474]) - v[367] * v[477] - v[368] * v[480];
		v[358] = v[246] * v[353] + v[250] * v[354] + v[251] * v[355];
		v[935] = v[341] * v[632] + v[351] * v[647] - v[358] * v[662] - v[368] * v[677];
		v[934] = v[341] * v[630] + v[351] * v[645] - v[358] * v[660] - v[368] * v[675];
		v[679] = -(v[29] * v[341]) - v[30] * v[351] + v[31] * v[358] + v[32] * v[368];
		v[664] = -(v[25] * v[341]) - v[26] * v[351] + v[27] * v[358] + v[28] * v[368];
		v[649] = -(v[21] * v[341]) - v[22] * v[351] + v[23] * v[358] + v[24] * v[368];
		v[634] = -(v[17] * v[341]) - v[18] * v[351] + v[19] * v[358] + v[20] * v[368];
		v[936] = v[341] * v[634] + v[351] * v[649] - v[358] * v[664] - v[368] * v[679];
		v[933] = v[340] * v[634] + v[350] * v[649] - v[357] * v[664] - v[367] * v[679];
		v[930] = v[339] * v[634] + v[349] * v[649] - v[356] * v[664] - v[366] * v[679];
		v[598] = -(v[356] * v[476]) - v[357] * v[479] - v[358] * v[482];
		v[597] = -(v[356] * v[475]) - v[357] * v[478] - v[358] * v[481];
		v[596] = -(v[356] * v[474]) - v[357] * v[477] - v[358] * v[480];
		v[918] = uA[0] - uB[0] + v[42] - v[88];
		v[917] = uA[1] - uB[1] + v[43] - v[89];
		v[916] = uA[2] - uB[2] + v[44] - v[90];
		v[264] = v[144] * v[169] + v[145] * v[173] + v[146] * v[174] - v[209] * v[234] - v[210] * v[238] - v[211] * v[239] + v[918];
		v[265] = v[144] * v[175] + v[145] * v[179] + v[146] * v[180] - v[209] * v[240] - v[210] * v[244] - v[211] * v[245] + v[917];
		v[266] = v[144] * v[181] + v[145] * v[185] + v[146] * v[186] - v[209] * v[246] - v[210] * v[250] - v[211] * v[251] + v[916];
		v[748] = sqrt((v[264] * v[264]) + (v[265] * v[265]) + (v[266] * v[266]));
		v[944] = v[209] + v[234] * v[264] + v[240] * v[265] + v[246] * v[266];
		v[943] = v[210] + v[238] * v[264] + v[244] * v[265] + v[250] * v[266];
		v[942] = v[211] + v[239] * v[264] + v[245] * v[265] + v[251] * v[266];
		v[941] = -v[144] + v[169] * v[264] + v[175] * v[265] + v[181] * v[266];
		v[940] = v[145] - v[173] * v[264] - v[179] * v[265] - v[185] * v[266];
		v[939] = -v[146] + v[174] * v[264] + v[180] * v[265] + v[186] * v[266];
		v[607] = -(v[264] * (v[361] * v[532] + v[363] * v[535] + v[365] * v[538])) - v[265] * (v[361] * v[547] + v[363] * v[550]
			+ v[365] * v[553]) - v[266] * (v[361] * v[562] + v[363] * v[565] + v[365] * v[568]) + v[366] * v[577] + v[367] * v[580]
			+ v[368] * v[583];
		v[606] = -(v[264] * (v[361] * v[531] + v[363] * v[534] + v[365] * v[537])) - v[265] * (v[361] * v[546] + v[363] * v[549]
			+ v[365] * v[552]) - v[266] * (v[361] * v[561] + v[363] * v[564] + v[365] * v[567]) + v[366] * v[576] + v[367] * v[579]
			+ v[368] * v[582];
		v[605] = -(v[264] * (v[361] * v[530] + v[363] * v[533] + v[365] * v[536])) - v[265] * (v[361] * v[545] + v[363] * v[548]
			+ v[365] * v[551]) - v[266] * (v[361] * v[560] + v[363] * v[563] + v[365] * v[566]) + v[366] * v[575] + v[367] * v[578]
			+ v[368] * v[581];
		v[601] = -(v[264] * (v[353] * v[532] + v[354] * v[535] + v[355] * v[538])) - v[265] * (v[353] * v[547] + v[354] * v[550]
			+ v[355] * v[553]) - v[266] * (v[353] * v[562] + v[354] * v[565] + v[355] * v[568]) + v[356] * v[577] + v[357] * v[580]
			+ v[358] * v[583];
		v[600] = -(v[264] * (v[353] * v[531] + v[354] * v[534] + v[355] * v[537])) - v[265] * (v[353] * v[546] + v[354] * v[549]
			+ v[355] * v[552]) - v[266] * (v[353] * v[561] + v[354] * v[564] + v[355] * v[567]) + v[356] * v[576] + v[357] * v[579]
			+ v[358] * v[582];
		v[599] = -(v[264] * (v[353] * v[530] + v[354] * v[533] + v[355] * v[536])) - v[265] * (v[353] * v[545] + v[354] * v[548]
			+ v[355] * v[551]) - v[266] * (v[353] * v[560] + v[354] * v[563] + v[355] * v[566]) + v[356] * v[575] + v[357] * v[578]
			+ v[358] * v[581];
		v[592] = v[264] * (v[344] * v[431] + v[346] * v[434] + v[348] * v[437]) + v[265] * (v[344] * v[446] + v[346] * v[449]
			+ v[348] * v[452]) + v[266] * (v[344] * v[461] + v[346] * v[464] + v[348] * v[467]) + v[349] * v[476] + v[350] * v[479]
			+ v[351] * v[482];
		v[591] = v[264] * (v[344] * v[430] + v[346] * v[433] + v[348] * v[436]) + v[265] * (v[344] * v[445] + v[346] * v[448]
			+ v[348] * v[451]) + v[266] * (v[344] * v[460] + v[346] * v[463] + v[348] * v[466]) + v[349] * v[475] + v[350] * v[478]
			+ v[351] * v[481];
		v[590] = v[264] * (v[344] * v[429] + v[346] * v[432] + v[348] * v[435]) + v[265] * (v[344] * v[444] + v[346] * v[447]
			+ v[348] * v[450]) + v[266] * (v[344] * v[459] + v[346] * v[462] + v[348] * v[465]) + v[349] * v[474] + v[350] * v[477]
			+ v[351] * v[480];
		v[586] = v[264] * (v[336] * v[431] + v[337] * v[434] + v[338] * v[437]) + v[265] * (v[336] * v[446] + v[337] * v[449]
			+ v[338] * v[452]) + v[266] * (v[336] * v[461] + v[337] * v[464] + v[338] * v[467]) + v[339] * v[476] + v[340] * v[479]
			+ v[341] * v[482];
		v[585] = v[264] * (v[336] * v[430] + v[337] * v[433] + v[338] * v[436]) + v[265] * (v[336] * v[445] + v[337] * v[448]
			+ v[338] * v[451]) + v[266] * (v[336] * v[460] + v[337] * v[463] + v[338] * v[466]) + v[339] * v[475] + v[340] * v[478]
			+ v[341] * v[481];
		v[584] = v[264] * (v[336] * v[429] + v[337] * v[432] + v[338] * v[435]) + v[265] * (v[336] * v[444] + v[337] * v[447]
			+ v[338] * v[450]) + v[266] * (v[336] * v[459] + v[337] * v[462] + v[338] * v[465]) + v[339] * v[474] + v[340] * v[477]
			+ v[341] * v[480];
		v[267] = v[147] * v[170] + v[148] * v[171] + v[149] * v[172] - v[212] * v[235] - v[213] * v[236] - v[214] * v[237] + v[42]
			- v[88];
		v[268] = v[147] * v[176] + v[148] * v[177] + v[149] * v[178] - v[212] * v[241] - v[213] * v[242] - v[214] * v[243] + v[43]
			- v[89];
		v[269] = v[147] * v[182] + v[148] * v[183] + v[149] * v[184] - v[212] * v[247] - v[213] * v[248] - v[214] * v[249] + v[44]
			- v[90];
		if (v[748] > 0.1e-7) { v02 = 1e0 / v[748]; v03 = (-(v02 / v[748])); v04 = ((2e0 * v02) / (v[748] * v[748])); }
		else {
			v02 = ((12500000e0 / 3e0) * (24e0 - (-0.1e-7 + v[748]) * (0.24e10 - 2e0 * (-1e0 + 100000000e0 * v[748]) *
				(0.2399999997e10 - 0.1199999994e18 * v[748] - 0.3e17 * (v[748] * v[748])))));
			v03 = ((-50000000e0 / 3e0) * (0.3599999994e10 - 0.4799999982e18 * v[748] + 0.6e25 * Power(v[748], 3)
				+ 0.1799999982e26 * (v[748] * v[748])));
			v04 = (0.1e17 * (799999997e0 - 0.599999994e17 * v[748] - 0.3e17 * (v[748] * v[748])));
		};
		v[278] = v02;
		v[279] = v[264] * v[278];
		v[280] = v[265] * v[278];
		v[281] = v[266] * v[278];
		v[282] = sqrt((v[267] * v[267]) + (v[268] * v[268]) + (v[269] * v[269]));
		if (v[282] > 0.1e-7) { v05 = 1e0 / v[282]; v06 = (-(v05 / v[282])); v07 = ((2e0 * v05) / (v[282] * v[282])); }
		else {
			v05 = ((12500000e0 / 3e0) * (24e0 - (-0.1e-7 + v[282]) * (0.24e10 - 2e0 * (-1e0 + 100000000e0 * v[282]) *
				(0.2399999997e10 - 0.1199999994e18 * v[282] - 0.3e17 * (v[282] * v[282])))));
			v06 = ((-50000000e0 / 3e0) * (0.3599999994e10 - 0.4799999982e18 * v[282] + 0.6e25 * Power(v[282], 3)
				+ 0.1799999982e26 * (v[282] * v[282])));
			v07 = (0.1e17 * (799999997e0 - 0.599999994e17 * v[282] - 0.3e17 * (v[282] * v[282])));
		};
		v[287] = v05;
		v[288] = v[267] * v[287];
		v[289] = v[268] * v[287];
		v[290] = v[269] * v[287];
		if ((v[279] * v[288] + v[280] * v[289] + v[281] * v[290]) < 0e0) {
			v[293] = -v[279];
			v[294] = -v[280];
			v[295] = -v[281];
		}
		...
		v[695] = (v[294] * v[294]);
		v[693] = (v[293] * v[293]);
		if (sqrt(Power(-(v[289] * v[293]) + v[288] * v[294], 2) + Power(v[290] * v[293] - v[288] * v[295], 2) + Power(-
			(v[290] * v[294]) + v[289] * v[295], 2)) > 0.1e-7) {
			v[298] = -(v[290] * v[294]) + v[289] * v[295];
			v[299] = v[290] * v[293] - v[288] * v[295];
			v[300] = -(v[289] * v[293]) + v[288] * v[294];
			v[301] = sqrt((v[298] * v[298]) + (v[299] * v[299]) + (v[300] * v[300]));
			if (v[301] > 0.1e-7) { v08 = 1e0 / v[301]; v09 = (-(v08 / v[301])); v010 = ((2e0 * v08) / (v[301] * v[301])); }
			else {
				v08 = ((12500000e0 / 3e0) * (24e0 - (-0.1e-7 + v[301]) * (0.24e10 - 2e0 * (-1e0 + 100000000e0 * v[301]) *
					(0.2399999997e10 - 0.1199999994e18 * v[301] - 0.3e17 * (v[301] * v[301])))));
				v09 = ((-50000000e0 / 3e0) * (0.3599999994e10 - 0.4799999982e18 * v[301] + 0.6e25 * Power(v[301], 3)
					+ 0.1799999982e26 * (v[301] * v[301])));
				v010 = (0.1e17 * (799999997e0 - 0.599999994e17 * v[301] - 0.3e17 * (v[301] * v[301])));
			};
			v[912] = 2e0 * v08 * tan(asin(v[301]) / 2e0);
			v[310] = v[298] * v[912];
			v[321] = (v[310] * v[310]);
			v[311] = v[299] * v[912];
			v[913] = v[311] / 2e0;
			...
			v[312] = v[300] * v[912];
			v[326] = v[312] * v[913];
			v[324] = (v[310] * v[312]) / 2e0;
			v[315] = (v[312] * v[312]);
			v[914] = v[314] + v[315];
			v[313] = 4e0 / (4e0 + v[321] + v[914]);
			v[915] = -0.5e0 * v[313];
			v[316] = 1e0 + v[914] * v[915];
			v[317] = v[313] * (-v[312] + v[319]);
			v[318] = v[313] * (v[311] + v[324]);
			v[320] = v[313] * (v[312] + v[319]);
			v[322] = 1e0 + (v[315] + v[321]) * v[915];
			v[323] = v[313] * (-v[310] + v[326]);
			v[325] = v[313] * (-v[311] + v[324]);
			v[327] = v[313] * (v[310] + v[326]);
			v[328] = 1e0 - (-v[314] - v[321]) * v[915];
		}
		else {
			v[316] = 1e0;
			v[317] = 0e0;
		...
		if ((*previouscontact)) {
			v[333] = v[147] * v[181] + v[148] * v[185] + v[149] * v[186] - v[212] * v[246] - v[213] * v[250] - v[214] * v[251]
				+ v[1] * v[325] + v[2] * v[327] + v[3] * v[328] + v[916];
			v[919] = v[295] * v[333];
			v[332] = v[147] * v[175] + v[148] * v[179] + v[149] * v[180] - v[212] * v[240] - v[213] * v[244] - v[214] * v[245]
				+ v[1] * v[320] + v[2] * v[322] + v[3] * v[323] + v[917];
			v[921] = v[294] * v[332];
			v[331] = v[147] * v[169] + v[148] * v[173] + v[149] * v[174] - v[212] * v[234] - v[213] * v[238] - v[214] * v[239]
				+ v[1] * v[316] + v[2] * v[317] + v[3] * v[318] + v[918];
			v[920] = -(v[293] * v[331]);
			v[330] = -(v[331] * (-1e0 + v[693])) - v[293] * (v[919] + v[921]);
			v[334] = -(v[332] * (-1e0 + v[695])) - v[294] * v[919] + v[294] * v[920];
			v[335] = -(v[333] * (-1e0 + v[697])) + v[295] * v[920] - v[295] * v[921];
		}
		else {
			v[330] = 0e0;
			v[334] = 0e0;
		...
		v[627] = -(v[17] * v[584]) - v[18] * v[590] - v[19] * v[596] - v[20] * v[602];
		v[628] = -(v[17] * v[585]) - v[18] * v[591] - v[19] * v[597] - v[20] * v[603];
		v[629] = -(v[17] * v[586]) - v[18] * v[592] - v[19] * v[598] - v[20] * v[604];
		v[636] = -(v[17] * v[587]) - v[18] * v[593] - v[19] * v[599] - v[20] * v[605];
		v[637] = -(v[17] * v[588]) - v[18] * v[594] - v[19] * v[600] - v[20] * v[606];
		v[638] = -(v[17] * v[589]) - v[18] * v[595] - v[19] * v[601] - v[20] * v[607];
		v[642] = -(v[21] * v[584]) - v[22] * v[590] - v[23] * v[596] - v[24] * v[602];
		v[643] = -(v[21] * v[585]) - v[22] * v[591] - v[23] * v[597] - v[24] * v[603];
		v[644] = -(v[21] * v[586]) - v[22] * v[592] - v[23] * v[598] - v[24] * v[604];
		v[651] = -(v[21] * v[587]) - v[22] * v[593] - v[23] * v[599] - v[24] * v[605];
		v[652] = -(v[21] * v[588]) - v[22] * v[594] - v[23] * v[600] - v[24] * v[606];
		v[653] = -(v[21] * v[589]) - v[22] * v[595] - v[23] * v[601] - v[24] * v[607];
		v[657] = -(v[25] * v[584]) - v[26] * v[590] - v[27] * v[596] - v[28] * v[602];
		v[658] = -(v[25] * v[585]) - v[26] * v[591] - v[27] * v[597] - v[28] * v[603];
		v[659] = -(v[25] * v[586]) - v[26] * v[592] - v[27] * v[598] - v[28] * v[604];
		v[666] = -(v[25] * v[587]) - v[26] * v[593] - v[27] * v[599] - v[28] * v[605];
		v[667] = -(v[25] * v[588]) - v[26] * v[594] - v[27] * v[600] - v[28] * v[606];
		v[668] = -(v[25] * v[589]) - v[26] * v[595] - v[27] * v[601] - v[28] * v[607];
		v[672] = -(v[29] * v[584]) - v[30] * v[590] - v[31] * v[596] - v[32] * v[602];
		v[673] = -(v[29] * v[585]) - v[30] * v[591] - v[31] * v[597] - v[32] * v[603];
		v[674] = -(v[29] * v[586]) - v[30] * v[592] - v[31] * v[598] - v[32] * v[604];
		v[681] = -(v[29] * v[587]) - v[30] * v[593] - v[31] * v[599] - v[32] * v[605];
		v[682] = -(v[29] * v[588]) - v[30] * v[594] - v[31] * v[600] - v[32] * v[606];
		v[683] = -(v[29] * v[589]) - v[30] * v[595] - v[31] * v[601] - v[32] * v[607];
		v[684] = v[150] * v[72] - v[397] * v[73] - v[391] * v[74];
		v[685] = v[397] * v[72] + v[150] * v[73] - v[394] * v[74];
		v[686] = v[391] * v[72] + v[394] * v[73] + v[150] * v[74];
		v[687] = v[118] * v[215] - v[120] * v[492] - v[119] * v[498];
		v[688] = v[119] * v[215] - v[120] * v[495] + v[118] * v[498];
		v[689] = v[120] * v[215] + v[118] * v[492] + v[119] * v[495];
		v[690] = -v[115] + v[146] * (-(v[173] * v[684]) + v[169] * v[685]) + v[145] * (v[174] * v[684] - v[169] * v[686]) + v[144] *
			(-(v[174] * v[685]) + v[173] * v[686]) + v[211] * (v[238] * v[687] - v[234] * v[688]) - v[210] * (v[239] * v[687]
				- v[234] * v[689]) + v[209] * (v[239] * v[688] - v[238] * v[689]) + v[69];
		v[923] = v[293] * v[690];
		v[691] = -v[116] + v[146] * (-(v[179] * v[684]) + v[175] * v[685]) + v[145] * (v[180] * v[684] - v[175] * v[686]) + v[144] *
			(-(v[180] * v[685]) + v[179] * v[686]) + v[211] * (v[244] * v[687] - v[240] * v[688]) - v[210] * (v[245] * v[687]
				- v[240] * v[689]) + v[209] * (v[245] * v[688] - v[244] * v[689]) + v[70];
		v[924] = v[294] * v[691];
		v[692] = -v[117] + v[146] * (-(v[185] * v[684]) + v[181] * v[685]) + v[145] * (v[186] * v[684] - v[181] * v[686]) + v[144] *
			(-(v[186] * v[685]) + v[185] * v[686]) + v[211] * (v[250] * v[687] - v[246] * v[688]) - v[210] * (v[251] * v[687]
				- v[246] * v[689]) + v[209] * (v[251] * v[688] - v[250] * v[689]) + v[71];
		v[922] = v[295] * v[692];
		v[694] = v[690] * v[693] + v[293] * (v[922] + v[924]);
		v[696] = v[691] * v[695] + v[294] * (v[922] + v[923]);
		v[698] = v[692] * v[697] + v[295] * (v[923] + v[924]);
		v[709] = -(v[234] * v[339]) - v[240] * v[340] - v[246] * v[341];
		v[710] = -(v[238] * v[339]) - v[244] * v[340] - v[250] * v[341];
		v[711] = -(v[239] * v[339]) - v[245] * v[340] - v[251] * v[341];
		v[718] = -(v[234] * v[349]) - v[240] * v[350] - v[246] * v[351];
		v[719] = -(v[238] * v[349]) - v[244] * v[350] - v[250] * v[351];
		v[720] = -(v[239] * v[349]) - v[245] * v[350] - v[251] * v[351];
		v[724] = -(v[169] * v[356]) - v[175] * v[357] - v[181] * v[358];
		v[725] = -(v[173] * v[356]) - v[179] * v[357] - v[185] * v[358];
		v[726] = -(v[174] * v[356]) - v[180] * v[357] - v[186] * v[358];
		v[736] = -(v[169] * v[366]) - v[175] * v[367] - v[181] * v[368];
		v[737] = -(v[173] * v[366]) - v[179] * v[367] - v[185] * v[368];
		v[738] = -(v[174] * v[366]) - v[180] * v[367] - v[186] * v[368];
		v[745] = -((v[926] * Power(v[746], v[761])) / (v[16] * Power(v[14], v[766])));
		b749 = v[748] < v[13];
		if (b749) {
			b751 = v[748] > v[14];
			if (b751) {
				v[760] = v[13] - v[748];
				v[925] = -(v[12] * Power(v[760], v[15]));
				v[753] = v[293] * v[925];
				v[755] = v[294] * v[925];
				v[756] = v[295] * v[925];
			}
			else {
				v[757] = -(v[12] * Power(v[746], v[15])) + v[745] * (Power(v[14], v[16]) - Power(v[748], v[16]));
				v[753] = v[293] * v[757];
				v[755] = v[294] * v[757];
				v[756] = v[295] * v[757];
			};
		...
		if (b749) {
			v[927] = 2e0 * (*zetan);
			if (b751) {
				v[763] = v[927] * sqrt(v[8] * v[926] * Power(v[760], v[761]));
				v[762] = v[694] * v[763];
				v[764] = v[696] * v[763];
				v[765] = v[698] * v[763];
			}
			else {
				v[767] = v[927] * sqrt(-(v[16] * v[745] * v[8] * Power(v[748], v[766])));
				v[762] = v[694] * v[767];
				v[764] = v[696] * v[767];
				v[765] = v[698] * v[767];
			};
			if (v[748] < v[13] && (v[293] * (v[753] + v[762]) + v[294] * (v[755] + v[764]) + v[295] * (v[756] + v[765])) < 0e0) {
				v[770] = v[762];
				v[771] = v[764];
				v[772] = v[765];
			}
		...
		v[777] = v[334] * v[4];
		v[778] = v[335] * v[4];
		v[782] = v[776] + v[9] * (-(v[118] * (v[339] * v[636] + v[349] * v[651] - v[356] * v[666] - v[366] * v[681])) - v[119] *
			(v[339] * v[637] + v[349] * v[652] - v[356] * v[667] - v[366] * v[682]) - v[120] * (v[339] * v[638] + v[349] * v[653]
				- v[356] * v[668] - v[366] * v[683]) - (v[339] * v[627] + v[349] * v[642] - v[356] * v[657] - v[366] * v[672]) * v[72] -
			(v[339] * v[628] + v[349] * v[643] - v[356] * v[658] - v[366] * v[673]) * v[73] - (v[339] * v[629] + v[349] * v[644]
				- v[356] * v[659] - v[366] * v[674]) * v[74] + v[115] * v[928] - v[69] * v[928] + v[116] * v[929] - v[70] * v[929]
			+ v[117] * v[930] - v[71] * v[930]);
		v[783] = v[777] + v[9] * (-(v[118] * (v[340] * v[636] + v[350] * v[651] - v[357] * v[666] - v[367] * v[681])) - v[119] *
			(v[340] * v[637] + v[350] * v[652] - v[357] * v[667] - v[367] * v[682]) - v[120] * (v[340] * v[638] + v[350] * v[653]
				- v[357] * v[668] - v[367] * v[683]) - (v[340] * v[627] + v[350] * v[642] - v[357] * v[657] - v[367] * v[672]) * v[72] -
			(v[340] * v[628] + v[350] * v[643] - v[357] * v[658] - v[367] * v[673]) * v[73] - (v[340] * v[629] + v[350] * v[644]
				- v[357] * v[659] - v[367] * v[674]) * v[74] + v[115] * v[931] - v[69] * v[931] + v[116] * v[932] - v[70] * v[932]
			+ v[117] * v[933] - v[71] * v[933]);
		v[784] = v[778] + v[9] * (-(v[118] * (v[341] * v[636] + v[351] * v[651] - v[358] * v[666] - v[368] * v[681])) - v[119] *
			(v[341] * v[637] + v[351] * v[652] - v[358] * v[667] - v[368] * v[682]) - v[120] * (v[341] * v[638] + v[351] * v[653]
				- v[358] * v[668] - v[368] * v[683]) - (v[341] * v[627] + v[351] * v[642] - v[358] * v[657] - v[368] * v[672]) * v[72] -
			(v[341] * v[628] + v[351] * v[643] - v[358] * v[658] - v[368] * v[673]) * v[73] - (v[341] * v[629] + v[351] * v[644]
				- v[358] * v[659] - v[368] * v[674]) * v[74] + v[115] * v[934] - v[69] * v[934] + v[116] * v[935] - v[70] * v[935]
			+ v[117] * v[936] - v[71] * v[936]);
		if (b749) {
			if ((*stick)) {
				if (sqrt((v[782] * v[782]) + (v[783] * v[783]) + (v[784] * v[784])) <= (v[5] * sqrt((v[773] * v[773]) +
					(v[774] * v[774]) + (v[775] * v[775])))) {
					v[789] = v[782];
					v[790] = v[783];
					v[791] = v[784];
					v[792] = 1e0;
					...
					v[793] = sqrt((v[782] * v[782]) + (v[783] * v[783]) + (v[784] * v[784]));
					if (v[793] > 0.1e-5) { v011 = 1e0 / v[793]; v012 = (-(v011 / v[793])); v013 = ((2e0 * v011) / (v[793] * v[793])); }
					else {
						v011 = ((24000000e0 - (-1e0 + 1000000e0 * v[793]) * (71999994e0 - 0.71999982e14 * v[793] + 0.6e19 * Power(v[793], 3
						) + 0.23999982e20 * (v[793] * v[793]))) / 24e0);
						v012 = ((-500000e0 / 3e0) * (35999994e0 - 0.47999982e14 * v[793] + 0.6e19 * Power(v[793], 3) + 0.17999982e20 *
							(v[793] * v[793])));
						v013 = (0.1e13 * (7999997e0 - 0.5999994e13 * v[793] - 0.3e13 * (v[793] * v[793])));
					};
					v[937] = v011 * v[6] * sqrt((v[773] * v[773]) + (v[774] * v[774]) + (v[775] * v[775]));
					v[789] = v[782] * v[937];
					v[790] = v[783] * v[937];
					v[791] = v[784] * v[937];
					v[792] = 0e0;
				};
				if (sqrt((v[776] * v[776]) + (v[777] * v[777]) + (v[778] * v[778])) > (v[5] * sqrt((v[773] * v[773]) +
					(v[774] * v[774]) + (v[775] * v[775])))) {
					if (v[4] > 0.1e-5) { v014 = 1e0 / v[4]; v015 = (-(v014 / v[4])); v016 = ((2e0 * v014) / (v[4] * v[4])); }
					else {
						v014 = ((24000000e0 - (-1e0 + 1000000e0 * v[4]) * (71999994e0 - 0.71999982e14 * v[4] + 0.6e19 * Power(v[4], 3)
							+ 0.23999982e20 * (v[4] * v[4]))) / 24e0);
						v015 = ((-500000e0 / 3e0) * (35999994e0 - 0.47999982e14 * v[4] + 0.6e19 * Power(v[4], 3) + 0.17999982e20 *
							(v[4] * v[4])));
						v016 = (0.1e13 * (7999997e0 - 0.5999994e13 * v[4] - 0.3e13 * (v[4] * v[4])));
					};
					v[811] = sqrt((v[776] * v[776]) + (v[777] * v[777]) + (v[778] * v[778]));
					if (v[811] > 0.1e-5) { v017 = 1e0 / v[811]; v018 = (-(v017 / v[811])); v019 = ((2e0 * v017) / (v[811] * v[811])); }
					else {
						v017 = ((24000000e0 - (-1e0 + 1000000e0 * v[811]) * (71999994e0 - 0.71999982e14 * v[811] + 0.6e19 * Power(v[811], 3
						) + 0.23999982e20 * (v[811] * v[811]))) / 24e0);
						v018 = ((-500000e0 / 3e0) * (35999994e0 - 0.47999982e14 * v[811] + 0.6e19 * Power(v[811], 3) + 0.17999982e20 *
							(v[811] * v[811])));
						v019 = (0.1e13 * (7999997e0 - 0.5999994e13 * v[811] - 0.3e13 * (v[811] * v[811])));
					};
					v[818] = -(v014 * v017 * v[6] * sqrt((v[773] * v[773]) + (v[774] * v[774]) + (v[775] * v[775])));
					v[817] = v[330] + v[776] * v[818];
					v[819] = v[334] + v[777] * v[818];
					v[820] = v[335] + v[778] * v[818];
				}
				else {
					v[817] = 0e0;
					v[819] = 0e0;
				...
				if (sqrt((v[782] * v[782]) + (v[783] * v[783]) + (v[784] * v[784])) <= (v[6] * sqrt((v[773] * v[773]) +
					(v[774] * v[774]) + (v[775] * v[775])))) {
					v[789] = v[782];
					v[790] = v[783];
					v[791] = v[784];
					...
					v[823] = sqrt((v[782] * v[782]) + (v[783] * v[783]) + (v[784] * v[784]));
					if (v[823] > 0.1e-5) { v020 = 1e0 / v[823]; v021 = (-(v020 / v[823])); v022 = ((2e0 * v020) / (v[823] * v[823])); }
					else {
						v020 = ((24000000e0 - (-1e0 + 1000000e0 * v[823]) * (71999994e0 - 0.71999982e14 * v[823] + 0.6e19 * Power(v[823], 3
						) + 0.23999982e20 * (v[823] * v[823]))) / 24e0);
						v021 = ((-500000e0 / 3e0) * (35999994e0 - 0.47999982e14 * v[823] + 0.6e19 * Power(v[823], 3) + 0.17999982e20 *
							(v[823] * v[823])));
						v022 = (0.1e13 * (7999997e0 - 0.5999994e13 * v[823] - 0.3e13 * (v[823] * v[823])));
					};
					v[938] = v020 * v[6] * sqrt((v[773] * v[773]) + (v[774] * v[774]) + (v[775] * v[775]));
					v[789] = v[782] * v[938];
					v[790] = v[783] * v[938];
					v[791] = v[784] * v[938];
					v[792] = 0e0;
				};
				if (sqrt((v[776] * v[776]) + (v[777] * v[777]) + (v[778] * v[778])) > (v[6] * sqrt((v[773] * v[773]) +
					(v[774] * v[774]) + (v[775] * v[775])))) {
					if (v[4] > 0.1e-5) { v023 = 1e0 / v[4]; v024 = (-(v023 / v[4])); v025 = ((2e0 * v023) / (v[4] * v[4])); }
					else {
						v023 = ((24000000e0 - (-1e0 + 1000000e0 * v[4]) * (71999994e0 - 0.71999982e14 * v[4] + 0.6e19 * Power(v[4], 3)
							+ 0.23999982e20 * (v[4] * v[4]))) / 24e0);
						v024 = ((-500000e0 / 3e0) * (35999994e0 - 0.47999982e14 * v[4] + 0.6e19 * Power(v[4], 3) + 0.17999982e20 *
							(v[4] * v[4])));
						v025 = (0.1e13 * (7999997e0 - 0.5999994e13 * v[4] - 0.3e13 * (v[4] * v[4])));
					};
					v[841] = sqrt((v[776] * v[776]) + (v[777] * v[777]) + (v[778] * v[778]));
					if (v[841] > 0.1e-5) { v026 = 1e0 / v[841]; v027 = (-(v026 / v[841])); v028 = ((2e0 * v026) / (v[841] * v[841])); }
					else {
						v026 = ((24000000e0 - (-1e0 + 1000000e0 * v[841]) * (71999994e0 - 0.71999982e14 * v[841] + 0.6e19 * Power(v[841], 3
						) + 0.23999982e20 * (v[841] * v[841]))) / 24e0);
						v027 = ((-500000e0 / 3e0) * (35999994e0 - 0.47999982e14 * v[841] + 0.6e19 * Power(v[841], 3) + 0.17999982e20 *
							(v[841] * v[841])));
						v028 = (0.1e13 * (7999997e0 - 0.5999994e13 * v[841] - 0.3e13 * (v[841] * v[841])));
					};
					v[847] = -(v023 * v026 * v[6] * sqrt((v[773] * v[773]) + (v[774] * v[774]) + (v[775] * v[775])));
					v[817] = v[330] + v[776] * v[847];
					v[819] = v[334] + v[777] * v[847];
					v[820] = v[335] + v[778] * v[847];
				}
				else {
					v[817] = 0e0;
					v[819] = 0e0;
		...
		ft[2] = v[791];
		(*stickupdated) = v[792];
		gtpupdated[0] = v[330] - v[817];
		gtpupdated[1] = v[334] - v[819];
		gtpupdated[2] = v[335] - v[820];
		v[867] = -(v[339] * v[789]) - v[340] * v[790] - v[341] * v[791];
		v[868] = -(v[349] * v[789]) - v[350] * v[790] - v[351] * v[791];
		v[869] = v[356] * v[789] + v[357] * v[790] + v[358] * v[791];
		v[870] = v[366] * v[789] + v[367] * v[790] + v[368] * v[791];
		v[875] = v[20] * v[867] + v[24] * v[868] + v[28] * v[869] + v[32] * v[870];
		v[874] = v[19] * v[867] + v[23] * v[868] + v[27] * v[869] + v[31] * v[870];
		v[873] = v[18] * v[867] + v[22] * v[868] + v[26] * v[869] + v[30] * v[870];
		v[872] = v[17] * v[867] + v[21] * v[868] + v[25] * v[869] + v[29] * v[870];
		Rc[0] = v[169] * v[773] + v[175] * v[774] + v[181] * v[775] - v[336] * v[872] - v[344] * v[873] - v[724] * v[874]
			- v[736] * v[875];
		Rc[1] = v[173] * v[773] + v[179] * v[774] + v[185] * v[775] - v[337] * v[872] - v[346] * v[873] - v[725] * v[874]
			- v[737] * v[875];
		Rc[2] = v[174] * v[773] + v[180] * v[774] + v[186] * v[775] - v[338] * v[872] - v[348] * v[873] - v[726] * v[874]
			- v[738] * v[875];
		Rc[3] = (-(v[146] * v[173]) + v[145] * v[174]) * v[773] + (-(v[146] * v[179]) + v[145] * v[180]) * v[774] + (-
			(v[146] * v[185]) + v[145] * v[186]) * v[775] - (-(v[146] * v[725]) + v[145] * v[726]) * v[874] - (-(v[146] * v[737])
				+ v[145] * v[738]) * v[875] - v[872] * (v[337] * v[939] + v[338] * v[940]) - v[873] * (v[346] * v[939] + v[348] * v[940]);
		Rc[4] = (v[146] * v[169] - v[144] * v[174]) * v[773] + (v[146] * v[175] - v[144] * v[180]) * v[774] + (v[146] * v[181]
			- v[144] * v[186]) * v[775] - (v[146] * v[724] - v[144] * v[726]) * v[874] - (v[146] * v[736] - v[144] * v[738]) * v[875]
			- v[872] * (-(v[336] * v[939]) + v[338] * v[941]) - v[873] * (-(v[344] * v[939]) + v[348] * v[941]);
		Rc[5] = (-(v[145] * v[169]) + v[144] * v[173]) * v[773] + (-(v[145] * v[175]) + v[144] * v[179]) * v[774] + (-
			(v[145] * v[181]) + v[144] * v[185]) * v[775] - (-(v[145] * v[724]) + v[144] * v[725]) * v[874] - (-(v[145] * v[736])
				+ v[144] * v[737]) * v[875] - v[872] * (-(v[336] * v[940]) - v[337] * v[941]) - v[873] * (-(v[344] * v[940])
					- v[346] * v[941]);
		Rc[6] = -(v[234] * v[773]) - v[240] * v[774] - v[246] * v[775] - v[709] * v[872] - v[718] * v[873] - v[353] * v[874]
			- v[361] * v[875];
		Rc[7] = -(v[238] * v[773]) - v[244] * v[774] - v[250] * v[775] - v[710] * v[872] - v[719] * v[873] - v[354] * v[874]
			- v[363] * v[875];
		Rc[8] = -(v[239] * v[773]) - v[245] * v[774] - v[251] * v[775] - v[711] * v[872] - v[720] * v[873] - v[355] * v[874]
			- v[365] * v[875];
		Rc[9] = -((-(v[211] * v[238]) + v[210] * v[239]) * v[773]) - (-(v[211] * v[244]) + v[210] * v[245]) * v[774] - (-
			(v[211] * v[250]) + v[210] * v[251]) * v[775] - (-(v[211] * v[710]) + v[210] * v[711]) * v[872] - (-(v[211] * v[719])
				+ v[210] * v[720]) * v[873] - v[874] * (-(v[354] * v[942]) + v[355] * v[943]) - v[875] * (-(v[363] * v[942])
					+ v[365] * v[943]);
		Rc[10] = -((v[211] * v[234] - v[209] * v[239]) * v[773]) - (v[211] * v[240] - v[209] * v[245]) * v[774] - (v[211] * v[246]
			- v[209] * v[251]) * v[775] - (v[211] * v[709] - v[209] * v[711]) * v[872] - (v[211] * v[718] - v[209] * v[720]) * v[873]
			- v[874] * (v[353] * v[942] - v[355] * v[944]) - v[875] * (v[361] * v[942] - v[365] * v[944]);
		Rc[11] = -((-(v[210] * v[234]) + v[209] * v[238]) * v[773]) - (-(v[210] * v[240]) + v[209] * v[244]) * v[774] - (-
			(v[210] * v[246]) + v[209] * v[250]) * v[775] - (-(v[210] * v[709]) + v[209] * v[710]) * v[872] - (-(v[210] * v[718])
				+ v[209] * v[719]) * v[873] - v[874] * (-(v[353] * v[943]) + v[354] * v[944]) - v[875] * (-(v[361] * v[943])
					+ v[363] * v[944]);
