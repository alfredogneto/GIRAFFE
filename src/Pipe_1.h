...
public:
	...
	void MountSeaCurrentLoading();		//Monta a parte estatica dos esfor�os de Morison - correnteza maritima
	...
	//Variaveis para fun��a gerada no AceGen
	...
	//Variaveis salvas em cada ponto de Gauss para posterior p�s-processamento e facilidade ao lidar com Lag. Atualizado
	...
	Matrix* B;
	Matrix* G;
	LagrangeSave* lag_save;							//Para salvar as variaveis devidas quando ha converg�ncia (acesso atraves da fun��o SaveLagrange())
