...
public:
	...
	int n_nodes;	//Número de nós do elemento
	...
	virtual void MountMassModal() = 0;							//Monta a matriz de massa para realização da análise modal
	virtual void MountDampingModal() = 0;						//Monta a matriz de amortecimento para realização da análise modal
	...
	virtual void SaveLagrange() = 0;	//Salva variáveis nos pontos de Gauss úteis para descrição lagrangiana atualizada
	...
	virtual void MountDynModal() = 0;	//Montagens para análise modal - inserção da matriz de massa e amortecimento na matriz de rigidez para posterior montagem global
