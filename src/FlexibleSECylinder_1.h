...
public:
	...
	void Gamma(double* zeta, double* theta, Matrix* G);						//Posição da superficie nas coordenadas convectivas escolhidas
	...
	double Curvature(double zeta, double theta, Matrix* e_dir);			//Retorna a curvatura da superficie segundo certa direção e calculada em certo conjunto de coordenadas convectivas
